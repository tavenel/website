...
- [🏆 Projet Dockerisation d'un Projet Multi-Composants](/cours/docker/projet-dev) : le but de ce projet est de dockeriser un projet personnel existant qui se compose de plusieurs composants. 
