...
Dans ce cas pratique, vous allez rédiger la recette fonctionnelle d'un projet existant et réaliser son exécution depuis un recettage fourni par un autre groupe.
...
#### 📌 Projet tests unitaires Bomberman
...
- [html](/cours/tests/unit/projet_bomberman_tests_unit.html)
- [pdf](/cours/tests/unit/projet_bomberman_tests_unit.pdf)
- [markdown](/cours/tests/unit/projet_bomberman_tests_unit.md)
