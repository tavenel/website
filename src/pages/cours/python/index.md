...
- [🤓 Cours de programmation des interfaces graphiques en Python : Tkinter](/cours/python/cours-tkinter)
...
- 💻 Exercices - niveau 1 : Sélection de problèmes pour s'initier au langage Python. Une notion différente par exercice. [📄 Sujet](/cours/python/exos-niv1)
- 💻 Exercices chiffrement : Des exercices autour du chiffrement de Cesar et de Vernam et calcul d'une fonction de hachage. [📄 Sujet](/cours/python/exos-chiffrement)
- 💻 Exercices librairie standard. [📄 Sujet](/cours/python/exos-stdlib)
- 💻 Exercices avancés : Une fois à l'aise avec la syntaxe de base. Nécessitent l'utilisation de plusieurs notions en même temps. [📄 Sujet](/cours/python/exos-avance)
...
- [📄 Sujet](/cours/python/tp-integration-langage)

#### 💻 TP - Space Invaders

- [📄 Sujet](/cours/python/tp-space_invaders)
...
- [📄 Sujet](/cours/python/kaplan-meier)

#### 💻 Exercices TCL/TK

- [📄 Sujet](/cours/python/exos-tk)
