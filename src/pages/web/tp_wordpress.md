...
La grande force de WordPress est sa facilité à intégrer d'autres services du cloud en mode SaaS.
...
1. Cliquez sur le bouton "Créer votre site Web".
1. Saisissez une adresse e-mail, un identifiant, un mot de passe, puis cliquez sur le bouton _Créer votre compte_.
1. Choisissez un nom de domaine : tapez le nom de domaine choisi et sélectionnez le nom de domaine gratuit utilisant l'extension `.wordpress.com`.
1. Dans l'écran suivant proposant de sélectionner un plan, cliquez en haut de la page sur le lien _Vous hésitez ? Commencer avec un site gratuit_.

## Création du site Web

1. Une fois le plan sélectionné, cliquez sur le bouton _Commencer_.
1. Cliquez sur _Modifier la page d'accueil_.
1. Éditez le contenu de la page d'accueil pour créer le site que vous souhaitez.
