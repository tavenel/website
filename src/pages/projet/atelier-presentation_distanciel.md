...
En identifiant un besoin existant, pensez collaborativement à une innovation permettant de révolutionner ce besoin.

1. En utilisant un outil collaboratif (par exemple Microsoft Teams), créez un groupe pour consigner les discussions et les documents futurs relatifs à l'innovation : 10'
2. Créez une représentation graphique de cette innovation par un dessin : 10'
3. Pichez et présentez le dessin de l'innovation à un autre groupe et obtenez leurs retours : 10'
4. En prenant en compte les retours, réalisez (20') :
...
- Le travail sera réalisé par groupe de quatre apprenants ;
