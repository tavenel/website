...
- _Cilium :_ Un CNI (Container Network Interface) pour Kubernetes qui utilise eBPF pour fournir des politiques de réseau et de sécurité à haute performance.
- _Falco :_ Un outil de détection d'intrusion en temps réel basé sur eBPF, conçu pour surveiller les comportements suspects dans les environnements cloud-native.
